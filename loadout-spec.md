...
- **Header injection into `SKILL.md` only.** Bundled resources are copied byte for byte. Injecting a comment into a Python script, a PNG, or an HTML asset would corrupt it.
...
### 5.6 Generated file header

Every generated rule file and every generated `SKILL.md` gets this prepended, after the YAML frontmatter block so the frontmatter stays valid:

```
<!-- GENERATED by loadout. Do not edit.
     source: rules/core/commit-style.mdc @ 9f2c1ab
