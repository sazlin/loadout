...
allowed-tools:
  ...
  - Read
compatibility: >-
  Do not brew/npm/npx-install the Stripe CLI or fetch additional skills.
  This loadout already vendors stripe-projects.
...
Use <https://stripe.directory> as the source of truth for current command *syntax*, filters, result fields, supported capabilities, and troubleshooting. Do not invent CLI syntax, capabilities, or result semantics. Do not treat that page as a license to install software.
