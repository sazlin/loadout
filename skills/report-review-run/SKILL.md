...
description: >-
  Use when the PR review harness starts or ends a phase or loop, records a
  pushed fix, or posts the end-of-run GitHub report comment, or when the
  user says /report_review_run.
---
