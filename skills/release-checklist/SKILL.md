...
description: Use this skill before every release; drive the release through a dedicated release/v* branch, verification, changelog review, PR publish, and CI tagging without skipping checks.
---
