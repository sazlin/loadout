...
description: >-
  Dispatch the four dimensional PR reviewers in parallel. Use when
  review_orchestrator starts or repeats a panel review, or when the user
  says dispatch panel review or /dispatch_panel_review. Do not review the
  diff yourself.
---
