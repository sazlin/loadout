# e2e_test_generator evals

Keyword eval for `e2e_test_generator`. Fixtures, goldens, and blank transcripts live next to this file.
...
spec = eval_by_id('e2e-checkout-spec')
