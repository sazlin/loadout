...
Repo-local only (like `skill-security-check`). Not vendored to consumers.
Do not copy this tree under `skills/`.
...
- Consumer loadouts / vendored skills (this skill is not shipped)
