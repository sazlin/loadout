...
description: Run project VERIFIERS.md claims sequentially as true/false checks via
  the verifier agent. Use after panel review is clean of significant issues, or when
  the user says /dispatch_verifiers. A missing VERIFIERS.md is an empty list. Never
