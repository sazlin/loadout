...
description: Use when planning, generating, or healing Playwright end-to-end tests;
  when asked for Playwright Test Agents, init-agents, a specs/ plan, seed.spec.ts,
  or a failing Playwright spec; or when wiring playwright-cli, Cursor Cloud browsers,
  or a healer quarantine lane.
metadata:
