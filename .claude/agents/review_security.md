...
description: 'Reviews a change set for security and privacy: unsafe data entering
  the system and accidental leaks of private user data. Use when the review orchestrator
  dispatches a security pass, or when the user asks for a security, privacy, injection,
  auth, or PII-leak review.'
model: inherit
readonly: true
tools:
- Read
