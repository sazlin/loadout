...
description: Explore the running app and write a Markdown test plan in specs/. Use
  when asked to plan E2E coverage, Playwright Test Agent planning, guest checkout
