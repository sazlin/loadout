...
description: Use when asked to plan E2E coverage, Playwright Test Agent planning,
  guest checkout plans, or playwright-test-planner. Do not write Playwright tests.
model: inherit
tools:
- Read
- Grep
