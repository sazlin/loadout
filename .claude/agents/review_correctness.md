...
description: 'Reviews a change set for correctness and data integrity: logic mistakes,
  edge cases, and data being lost, overwritten, or copied by accident. Use when the
  review orchestrator dispatches a correctness pass, or when the user asks for a correctness,
  logic, data-loss, or data-integrity review.'
model: inherit
readonly: true
tools:
- Read
