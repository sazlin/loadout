...
def test_base_sync_vendors_no_autonomous_external_comms(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert "sean azlin" in dest.read_text().lower()
