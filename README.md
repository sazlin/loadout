...
| `ref` | yes | Release tag or branch to resolve on every remote sync (`v0.39.0`, `main`, …) |
...
just test     # pytest
just release 0.39.0   # on release/v0.39.0: validate, push, open PR; CI tags on merge
