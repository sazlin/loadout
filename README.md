...
| `github` | `base` | — | <ul><li><a href="skills/github-upload-media-to-pr/SKILL.md"><code>github-upload-media-to-pr</code></a></li><li><a href="skills/make-readme/SKILL.md"><code>make-readme</code></a></li></ul> | — | — | — | — |
...
| `ref` | yes | Release tag or branch to resolve on every remote sync (`v0.42.0`, `main`, …) |
...
just test     # pytest
just release 0.42.0   # on release/v0.42.0: validate, push, open PR; CI tags on merge
