...
| `.cursor/rules/no-auto-merge.mdc` | Always | Never enable pull-request auto-merge. When told to watch a PR or merge when green, wait until every attached check has finished successfully. |
